...
document.getElementById('subscription-form').addEventListener('submit', verifyFormInputs);
...
function verifyFormInputs(event) {
    ...
    formData.forEach((blabla, lolo) => {
        console.log(`${lolo}: ${blabla}`);  
    });
  };
...
// $form.addEventListener("input",verifyFormInputs);
